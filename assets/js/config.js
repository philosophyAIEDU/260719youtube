...
PhilApp.config = {
   ...
   * =================================================================== */
  BUILTIN_YT_KEY: "AIzaSyBjd21bOjfF27lFxKQYRN6Q9uB1whaFtaw",
  BUILTIN_GM_KEY: "",   // ⚠️ 확인 중 — 전달받은 값이 표준 Gemini 키 형식(AIzaSy...)과 달라 보류.
                         //    Google AI Studio(https://aistudio.google.com/app/apikey)의
                         //    "API 키" 값을 다시 확인해 주세요.
